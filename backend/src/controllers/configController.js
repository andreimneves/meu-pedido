...
const configController = {
    ...
    async atualizarConfiguracoes(req, res) {
        try {
            ...
            // MESCLAGEM BLINDADA: Se a tela atual não enviou uma informação, usa a que já estava guardada!
            ...
            if (existe.rows.length > 0) {
                await pool.query(
                    ...
                    [
                        ...
                        frete_gratis_ativo, frete_gratis_acima, banner_ativo, banner_texto, 
                        banner_cor, banner_cor_txt, banner_icone, logo_url, 
            ...
            res.json({ mensagem: 'Configurações guardadas com segurança absoluta!' });
        } catch (error) { 
